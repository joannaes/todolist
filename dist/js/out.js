...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var checkboxInput = void 0;
  var buttonDel = void 0;
  var listItems = document.getElementsByTagName("li");
  var addBtn = document.getElementById("add");
  var form = document.querySelector("form");
  var mainContainer = document.getElementById("list-form-container");
  var list = void 0;
  var counter = void 0;
  var allTasksData = void 0;

  if (listItems.length == 0) {
    list = null;
    counter = 0;

    allTasksData = localStorage.getItem("allTasksData") ? JSON.parse(localStorage.getItem("allTasksData")) : [];

    for (var z = 0; z < allTasksData.length; z++) {
      counter++;
      if (list == null) {
      ...
      buttonDel.addEventListener("click", function (e) {
        if (listItems.length > 1) {
          var taskForDeletion = this.parentNode.querySelector("span");
          for (var y = 0; y < allTasksData.length; y++) {
      ...
      checkboxInput.addEventListener("click", function (e) {
        var taskDone = this.parentNode.querySelector("span");
        var buttonDelDone = this.parentNode.querySelector("button");
  ...
  function addTask(e) {
    ...
    if (newTask.value.length > 0) {
      ...
      checkboxInput = document.createElement("input");
      var _labelCheck = document.createElement("label");
      var _taskName = document.createElement("span");
      buttonDel = document.createElement("button");
      //dodawanie atrybutów
      checkboxInput.setAttribute("type", "checkbox");
      checkboxInput.id = "checkField-" + counter;
      checkboxInput.name = "checkField-" + counter;
      _labelCheck.setAttribute("class", "check");
      _labelCheck.htmlFor = "checkField-" + counter;
      buttonDel.setAttribute("class", "delete");
      _taskName.id = counter;
      _taskName.innerHTML = newTask.value;
      list.appendChild(_listItem); //dodawanie elementów do drzewa DOM
      _listItem.appendChild(checkboxInput);
      _listItem.appendChild(_labelCheck);
      _listItem.appendChild(_taskName);
      _listItem.appendChild(buttonDel);

      allTasksData.push({ id: _taskName.id, taskName: newTask.value });
      localStorage.clear();
      localStorage.setItem("allTasksData", JSON.stringify(allTasksData));
...
module.exports = __webpack_require__.p + "assets/589fbb4a5bbfa151e24eafd019cdb8eb.png";

/***/ }),
/* 7 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "assets/6ae7bdaecd4d89b84586f3a066d56436.png";

/***/ }),
/* 8 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "assets/c31df72a7a05a1419278f4886bcfcf7e.png";

/***/ }),
/* 9 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "assets/c28f7531e95302ef05a2ec8f990768ef.png";
